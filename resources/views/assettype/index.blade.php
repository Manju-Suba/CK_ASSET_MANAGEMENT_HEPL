                ...
                <form action="#" id="formadd">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="asset_category" class="form-control nice_select" id="asset_category" required>
            ...
            <div class="modal-content">
                <form action="#" id="formedit">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Category</label>
                            <select name="edit_asset_category" class="form-control nice_select" id="edit_asset_category" required>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(data.response=="Data Already Exist"){
                    ...
                    $("#form_resp").html("Asset Type Already Exist");
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(data.response=="Data Already Exist"){
                    ...
                    $("#edit_form_resp").html("Asset Type Already Exist");
...
$('#edit').on('show.bs.modal', function(e) {
	...
	$.ajax({
		...
		success: function(data) {
			$("#editid").val(id);
			$("#edit_asset_category").html(data.category_div);
