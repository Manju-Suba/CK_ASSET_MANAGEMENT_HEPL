                ...
                <form action="#" id="formadd">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="business" class="form-control nice_select" id="business" required>
                ...
                <form action="#" id="formedit">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="edit_business" class="form-control nice_select" id="edit_business" required>
            ...
            success: function(data) {
                console.log(data);
                 if(data.response=="Data Already Exist"){
                    ...
                    $("#form_resp").html("Department Already Exist");
        ...
        $.ajax({
            ...
            success: function(data) {
			  ...
			  if(data.response=="Data Already Exist"){
                    ...
                    $("#edit_form_resp").html("Department Already Exist");
