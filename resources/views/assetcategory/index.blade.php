...
<section class="">
    <div class="content p-4">
        <div class="row pt-3">
            <div class="col-md-6">
                <h3 class="">Asset Category list</h3>
            </div>
                ...
                <form action="#" id="formadd">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label><?php echo trans('lang.business');?></label>
            ...
            <div class="modal-content">
                <form action="#" id="formedit">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label><?php echo trans('lang.business');?></label>
                            <select name="edit_business_id" id="edit_business_id" required class="form-control select2"  >
                                <option value="">Choose Business</option>
                                    @foreach($business as $row)
                                    <option value="{{$row->id}}">{{$row->name}}</option>
                                    @endforeach
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(data.response=="Data Already Exist"){
                    ...
                    $("#form_resp").html("Asset Category Already Exist");
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(data.response=="Data Already Exist"){
                    ...
                    $("#edit_form_resp").html("Asset Category Already Exist");
...
$('#edit').on('show.bs.modal', function(e) {
	...
	$.ajax({
		type: "POST",
		url: "{{ url('assetcategorybyid')}}",
		data: {id:id},
		dataType: "JSON",
		success: function(data) {
			$("#editid").val(id);
			$("#edit_business_id").val(data.message.business_id);
