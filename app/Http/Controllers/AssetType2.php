...
class AssetType extends Controller
{
    ...
    public function getdata(){
        ...
        // ->addColumn('category_div', function($data) {

        //     $get_asset_category_details = DB::table('asset_category_models')->select(['asset_category_models.*'])->where('id', $data->c_id)->get();

        //     $category_div = $get_asset_category_details[0]->name;
        //     return $category_div;
        // })
    ...
    public function save(Request $request){
        ...
        $data           = array('field_id'=>$field_id,'c_id'=>$c_id, 'name'=>$name, 'description'=>$description,'created_at'=>$created_at,'status'=>'Active', 'updated_at'=>$updated_at);
